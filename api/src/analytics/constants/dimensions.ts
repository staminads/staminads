...
export const DIMENSIONS: Record<string, DimensionDefinition> = {
  ...
  stm_1: { name: 'stm_1', column: 'stm_1', type: 'string', category: 'Custom' },
  stm_2: { name: 'stm_2', column: 'stm_2', type: 'string', category: 'Custom' },
  stm_3: { name: 'stm_3', column: 'stm_3', type: 'string', category: 'Custom' },
  stm_4: { name: 'stm_4', column: 'stm_4', type: 'string', category: 'Custom' },
  stm_5: { name: 'stm_5', column: 'stm_5', type: 'string', category: 'Custom' },
  stm_6: { name: 'stm_6', column: 'stm_6', type: 'string', category: 'Custom' },
  stm_7: { name: 'stm_7', column: 'stm_7', type: 'string', category: 'Custom' },
  stm_8: { name: 'stm_8', column: 'stm_8', type: 'string', category: 'Custom' },
  stm_9: { name: 'stm_9', column: 'stm_9', type: 'string', category: 'Custom' },
  stm_10: { name: 'stm_10', column: 'stm_10', type: 'string', category: 'Custom' },
};
