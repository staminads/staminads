...
export const WORKSPACE_SCHEMAS: Record<string, string> = {
  ...
  sessions_mv: `
    ...
    SELECT
      ...
      argMin(stm_1, events.created_at) as stm_1,
      argMin(stm_2, events.created_at) as stm_2,
      argMin(stm_3, events.created_at) as stm_3,
      argMin(stm_4, events.created_at) as stm_4,
      argMin(stm_5, events.created_at) as stm_5,
      argMin(stm_6, events.created_at) as stm_6,
      argMin(stm_7, events.created_at) as stm_7,
      argMin(stm_8, events.created_at) as stm_8,
      argMin(stm_9, events.created_at) as stm_9,
      argMin(stm_10, events.created_at) as stm_10,
