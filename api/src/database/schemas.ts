...
export const WORKSPACE_SCHEMAS: Record<string, string> = {
  events: `
    CREATE TABLE IF NOT EXISTS {database}.events (
      ...
      channel_version LowCardinality(String) DEFAULT '',
      channel_group_version LowCardinality(String) DEFAULT '',
      cd_1_version LowCardinality(String) DEFAULT '',
      cd_2_version LowCardinality(String) DEFAULT '',
      cd_3_version LowCardinality(String) DEFAULT '',
      cd_4_version LowCardinality(String) DEFAULT '',
      cd_5_version LowCardinality(String) DEFAULT '',
      cd_6_version LowCardinality(String) DEFAULT '',
      cd_7_version LowCardinality(String) DEFAULT '',
      cd_8_version LowCardinality(String) DEFAULT '',
      cd_9_version LowCardinality(String) DEFAULT '',
      cd_10_version LowCardinality(String) DEFAULT '',
  ...
  sessions_mv: `
    ...
    SELECT
      ...
      argMin(channel_version, events.created_at) as channel_version,
      argMin(channel_group_version, events.created_at) as channel_group_version,
      argMin(cd_1_version, events.created_at) as cd_1_version,
      argMin(cd_2_version, events.created_at) as cd_2_version,
      argMin(cd_3_version, events.created_at) as cd_3_version,
      argMin(cd_4_version, events.created_at) as cd_4_version,
      argMin(cd_5_version, events.created_at) as cd_5_version,
      argMin(cd_6_version, events.created_at) as cd_6_version,
      argMin(cd_7_version, events.created_at) as cd_7_version,
      argMin(cd_8_version, events.created_at) as cd_8_version,
      argMin(cd_9_version, events.created_at) as cd_9_version,
      argMin(cd_10_version, events.created_at) as cd_10_version,
