...
export function getDemoFilters(): FilterDefinition[] {
  ...
  filters.push(
    ...
    createChannelFilter(
      'Instagram Ads',
      utmConditions('instagram', 'social'),
      'social-paid',
      'instagram-ads',
      880,
    ),
  ...
  filters.push(
    ...
    createChannelFilter(
      'Affiliate UTM',
      utmConditions('affiliate', 'referral'),
      'referral',
      'affiliate',
      770,
    ),
  ...
  filters.push(
    ...
    createChannelFilter(
      'DuckDuckGo Organic',
      referrerCondition('duckduckgo.com'),
      'search-organic',
      'duckduckgo-organic',
      570,
    ),
  ...
  filters.push(
    createChannelFilter(
      'Facebook Organic',
      referrerCondition('facebook.com'),
      'social-organic',
      'facebook-organic',
      550,
    ),
    ...
    createChannelFilter(
      'Instagram Organic',
      referrerCondition('instagram.com'),
      'social-organic',
      'instagram-organic',
      530,
    ),
    createChannelFilter(
      'LinkedIn Referral',
      referrerCondition('linkedin.com'),
      'social-organic',
      'linkedin',
      520,
    ),
    ...
    createChannelFilter(
      'Pinterest Referral',
      referrerCondition('pinterest.com'),
      'social-organic',
      'pinterest',
      490,
    ),
  ...
  filters.push(
    createChannelFilter(
      'MacRumors',
      referrerCondition('macrumors.com'),
      'tech-news',
      'macrumors',
      450,
    ),
    ...
    createChannelFilter(
      'The Verge',
      referrerCondition('theverge.com'),
      'tech-news',
      'theverge',
      430,
    ),
    ...
    createChannelFilter(
      'TechCrunch',
      referrerCondition('techcrunch.com'),
      'tech-news',
      'techcrunch',
      410,
    ),
    createChannelFilter(
      'Engadget',
      referrerCondition('engadget.com'),
      'tech-news',
      'engadget',
      400,
    ),
  ...
  filters.push(
    createProductFilter(
      'iPhone 17 Pro',
      pathCondition('^/iphone-17-pro/'),
      'iPhone',
      450,
    ),
    createProductFilter(
      'iPhone Air',
      pathCondition('^/iphone-air/'),
      'iPhone',
      440,
    ),
    createProductFilter(
      'iPhone 17',
      pathCondition('^/iphone-17/'),
      'iPhone',
      430,
    ),
    createProductFilter(
      'iPhone 16e',
      pathCondition('^/iphone-16e/'),
      'iPhone',
      420,
    ),
    createProductFilter(
      'iPhone Compare',
      pathCondition('^/iphone/compare/'),
      'iPhone',
      410,
    ),
    createProductFilter(
      'iPhone General',
      pathCondition('^/iphone/'),
      'iPhone',
      400,
    ),
    createProductFilter(
      'Buy iPhone',
      pathCondition('/buy_iphone'),
      'iPhone',
      390,
    ),
  );
  ...
  filters.push(
    createProductFilter(
      'MacBook Air',
      pathCondition('^/macbook-air/'),
      'Mac',
      380,
    ),
    createProductFilter(
      'MacBook Pro',
      pathCondition('^/macbook-pro/'),
      'Mac',
      370,
    ),
  ...
  filters.push(
    createProductFilter(
      ...
      pathCondition('^/apple-watch-series-11/'),
      'Watch',
      250,
    ),
    createProductFilter(
      'Apple Watch Ultra 3',
      pathCondition('^/apple-watch-ultra-3/'),
      'Watch',
      240,
    ),
    createProductFilter(
      'Apple Watch SE 3',
      pathCondition('^/apple-watch-se-3/'),
      'Watch',
      230,
    ),
    createProductFilter(
  ...
  filters.push(
    createProductFilter(
      'AirPods Pro',
      pathCondition('^/airpods-pro/'),
      'AirPods',
      200,
    ),
    createProductFilter(
      'AirPods 4',
      pathCondition('^/airpods-4/'),
      'AirPods',
      190,
    ),
    createProductFilter(
      'AirPods Max',
      pathCondition('^/airpods-max/'),
      'AirPods',
      180,
    ),
    createProductFilter(
      'AirPods General',
      pathCondition('^/airpods/'),
      'AirPods',
      170,
    ),
  );
  ...
  filters.push(
    createProductFilter(
      'Apple TV 4K',
      pathCondition('^/apple-tv-4k/'),
      'TV & Home',
      160,
    ),
    createProductFilter(
      'HomePod mini',
      pathCondition('^/homepod-mini/'),
      'TV & Home',
      150,
    ),
    createProductFilter(
      'TV & Home General',
      pathCondition('^/tv-home/'),
      'TV & Home',
      140,
    ),
  );
  ...
  filters.push(
    createProductFilter(
      'Vision Pro',
      pathCondition('^/apple-vision-pro/'),
      'Vision Pro',
      130,
    ),
  );
  ...
  filters.push({
    ...
    conditions: [], // Always matches
    operations: [
      { dimension: 'stm_1', action: 'set_default_value', value: 'Other' },
    ],
    enabled: true,
    version: '',
    createdAt: now,
