...
interface TabbedChannelsWidgetProps {
  title: string
  data: ChannelData[]
  loading: boolean
...
export function TabbedChannelsWidget({
  title,
  data,
  loading,
  showComparison = true,
  emptyText = 'No data available',
}: TabbedChannelsWidgetProps) {
  ...
  return (
    <div className="rounded-md overflow-hidden bg-white">
      ...
      <div className="flex items-center px-4 py-3 border-b border-gray-200">
        <span className="flex-1 text-xs font-medium text-gray-600">Channel</span>
