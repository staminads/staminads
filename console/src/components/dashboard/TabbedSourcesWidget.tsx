...
interface TabbedSourcesWidgetProps {
  title: string
  data: SourceData[]
  loading: boolean
  ...
  return (
    <div className="rounded-md overflow-hidden bg-white">
      ...
      <div className="flex items-center px-4 py-3 border-b border-gray-200">
        <span className="flex-1 text-xs font-medium text-gray-600">Referrer domain</span>
            ...
            return (
              ...
              >
                ...
                <div className="relative flex-1 min-w-0 pr-4 h-full flex items-center pl-1.5 gap-2">
                  ...
                  />
                  {showFavicon && row.dimension_value && (
                    <img
                      src={`/api/tools.favicon?url=https://${encodeURIComponent(row.dimension_value)}`}
                      alt=""
