...
export const WRITABLE_DIMENSIONS = [
  ...
  { value: 'cd_3', label: 'Custom Dimension 3', category: 'Custom' },
  { value: 'cd_4', label: 'Custom Dimension 4', category: 'Custom' },
  { value: 'cd_5', label: 'Custom Dimension 5', category: 'Custom' },
  { value: 'cd_6', label: 'Custom Dimension 6', category: 'Custom' },
  { value: 'cd_7', label: 'Custom Dimension 7', category: 'Custom' },
  { value: 'cd_8', label: 'Custom Dimension 8', category: 'Custom' },
  { value: 'cd_9', label: 'Custom Dimension 9', category: 'Custom' },
  { value: 'cd_10', label: 'Custom Dimension 10', category: 'Custom' },
  // UTM fields
  { value: 'utm_source', label: 'UTM Source', category: 'UTM' },
  { value: 'utm_medium', label: 'UTM Medium', category: 'UTM' },
  { value: 'utm_campaign', label: 'UTM Campaign', category: 'UTM' },
